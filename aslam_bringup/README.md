...
Download and install outside the ROS workspace the uncertainty octomap package:\
`git clone https://gitlab.tekniker.es/sai/personal/illuvia/freiburg/octomap.git`

Download all required packages to your ROS workspace:\
(optional)`roscd && cd ../src/`\
`git clone --recurse-submodules https://gitlab.tekniker.es/sai/personal/illuvia/freiburg/aslam-system.git`

Note: some ROS packages may have to be installed manually.
