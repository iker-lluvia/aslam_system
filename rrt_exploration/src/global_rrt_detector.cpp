...
int main(int argc, char **argv)
{
  ...
  ROS_INFO_STREAM("Waiting for the map");
  ...
  ROS_INFO_STREAM("Waiting the exploration region to be defined / clicked points published");
  while(points.points.size()<5)
  {
    ros::spinOnce();
    pub.publish(points) ;
  }
  ROS_INFO_STREAM("Region / Points received!");
